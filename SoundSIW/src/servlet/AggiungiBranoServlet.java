...
@WebServlet("/AggiungiBranoServlet")

public class AggiungiBranoServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{	
			...
			out.println("<p style='color:red;'> Brano aggiunto con successo </p>");
		}
		else
		{
			out.println("<meta http-equiv='refresh' content='3';URL=playlist.jsp'>");
			out.println("<p style='color:red;'> Brano già presente </p>");
